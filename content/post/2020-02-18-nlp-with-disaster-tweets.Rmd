...
4. Improve skills in PyTorch deep learning framework for model training and prediction. 
...
The following series of posts tackle the above project goals sequentially 
 ...
 - Project Part 7 - [NLP with Disaster Tweets: Part 7 Vanilla RNN and GRU](/2020/09/nlp-with-disaster-tweets-part-7-vanilla-rnn-and-gru.en-us/){target="_blank"}