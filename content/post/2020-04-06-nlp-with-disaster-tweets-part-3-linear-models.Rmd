...
The f1-score metric on the validation set comes out to be 0.81 which is much higher compared to the baseline and also the K-Nearest Neighbor model that we built in [Part 2](/2020/02/nlp-with-disaster-tweets-part-2-nearest-neighbor-models/){target="_blank"}. Lets try and visualize the variable importance for different features that we used to train our model. 
