...
Music Artist Recommendation System using the [Last.fm
Dataset](https://grouplens.org/datasets/hetrec-2011/). Exploratory data
analysis.
...
We will work with the final above 3 dataframes, metadata, ratings and
friends. Lets drop the rest of them.
...
<img
src="/post/2019-07-18-music-recommendation-system_files/figure-html/unnamed-chunk-12-1.png"
width="768" />
...
Looks like a highly cleaned dataset, where every user has exactly 50
ratings (or user’s play counts of exactly 50 artists).
...
I’ll skip worrying about NA urls and pictureURLs for now. Lets explore
the rows where name is NA.
...
Looks like even though we dont have the name of these artists, we have
ratings for them in the ratings dataframe, so we’ll keep them.
...
I dont think we will need the 2 URL columns for this study, dropping
them for now.
...
<img
src="/post/2019-07-18-music-recommendation-system_files/figure-html/unnamed-chunk-27-1.png"
width="672" />
...
<img
src="/post/2019-07-18-music-recommendation-system_files/figure-html/unnamed-chunk-28-1.png"
width="672" />

Looks like few of the most popular Artists in this dataset are Britney
Spears, Lady Gaga and Christina Aguilera and as expected, Rock and Pop
are the most popular tags. Lets see which are the most popular artists
in the top most popular tags.
...
<div id="htmlwidget-1" class="sunburst html-widget"
style="width:672px;height:480px; position:relative;">
...
Alright, so we know the most popular artists in each popular tag as
provided by the user. Don’t worry, Beatles is right up there in the
“rock” tag! :)
...
I think I will wrap up the exploration phase for now. Lets export the
data so we can model it in a later post.
