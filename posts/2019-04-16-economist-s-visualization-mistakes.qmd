...
women_research %>%
  ...
  labs(x = "Field of study",
       ...
       caption = "Based on data from The Economist")
```
<img src="/post/2019-04-16-economist-s-visualization-mistakes_files/figure-html/unnamed-chunk-15-1.png" width="960" />
