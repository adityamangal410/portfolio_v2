...
## 4 Owen Smith                     127
## 5 Andy Burnham                   105
## 6 Saving Labour                   56</code></pre>
<pre class="r"><code>corbyn %&gt;% 
...
<pre class="r"><code>women_research %&gt;% 
