...
# Project Summary
With this project, I’ll apply and practice various NLP techniques, along with trying my hands on the tidymodels framework.
I will use the NLP getting started challenge on kaggle for its dataset and also evaluating model performance using submissions.
# Project Goals
